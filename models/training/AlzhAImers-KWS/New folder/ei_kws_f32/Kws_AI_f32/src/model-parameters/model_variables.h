...
const char* ei_classifier_inferencing_categories[] = { "ask_med_details", "ask_schedule", "ask_time", "confirm_taken", "deny_taken", "irrelevant", "notify_sos", "remind_later" };
...
const ei_impulse_t impulse_726434_0 = {
    .project_id = 726434,
    .project_owner = "shivanshmp1",
    .project_name = "KWS-alzhAImers",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_726434_0 = ei_impulse_handle_t( &impulse_726434_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_726434_0;
